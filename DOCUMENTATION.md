...
~~~
  ...
  System - System wide and admin settings (x86_64)
	...
	--cmd SSH002 - Remove sandboxed SSH server (ssh://10.1.0.117:2222)
  ...
  Software - Run/Install 3rd party applications (Update the package lists.)
	...
	--cmd ADG002 - AdGuardHome remove (http://10.1.0.117:3000)
	...
	--cmd DAT002 - Mariadb remove (Server: 10.1.0.117)
	...
	--cmd MYA002 - phpMyAdmin remove (http://10.1.0.117:8071)
	...
	--cmd POR002 - Portainer remove (http://10.1.0.117:9000)
	...
	--cmd IMM002 - Immich remove (http://10.1.0.117:8077)
	...
	--cmd NAX002 - NetAlertX network scanner remove (http://10.1.0.117:20211)
	--cmd NAX003 - NetAlertX network scanner purge with data folder
    Management - Remote File & Management tools
	--cmd CPT001 - Cockpit web-based management tool (http://10.1.0.117:9090)
	...
	--cmd OCT002 - OctoPrint remove (http://10.1.0.117:7981)
